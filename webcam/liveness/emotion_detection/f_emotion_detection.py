from webcam.liveness import config as cfg
...
class predict_emotions():
    ...
    def __init__(self):
        ...
        # print("###### f_emotion_detection ######",cfg.path_model)
        self.model = load_model(cfg.path_model)
        # print("###### f_emotion_detection :: model ######",model)
    ...
    def get_emotion(self,img,boxes_face):
        # self.model = load_model(cfg.path_model)
        # print("####### get_emotion -1 ###### ",self.model)
        emotions = []
        if len(boxes_face)!=0:
